...
import { HoverComponent, useReceivedChatColumnn } from './TableAction';
import {
  VacancyStatus,
  useGetReceivedApplicationAdmin,
...
const AdminChatReceived = () => {
  const column = useReceivedChatColumnn();

  const received = useGetReceivedApplicationAdmin();
...
export default AdminChatReceived;
