...
import { IGradeResponse } from 'service/master/service-grade';

type GradeData = IGradeResponse['results'][number];
...
export const HoverComponent = (
  props: HoverComponentProps<GradeData> & Props,
) => {
  return (
    <HStack gap="0.5rem">
      <FormButton
...
export const useGradeColumn = () => {
  const columns = useMemo<ColumnDef<GradeData, any>[]>(
    () => [
      {
        header: 'Index',
